<?php
$current_page = 'writing-guides';
$page_title = 'Writing Guides | Insight Research';
$meta_description = 'Expert guides on content writing, copywriting, research, and business communication.';
include 'header.php';
?>
